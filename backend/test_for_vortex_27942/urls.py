"""test_for_vortex_27942 URL Configuration
...
admin.site.site_header = "Test for Vortex"
admin.site.site_title = "Test for Vortex Admin Portal"
admin.site.index_title = "Test for Vortex Admin"

# swagger
api_info = openapi.Info(
    title="Test for Vortex API",
    default_version="v1",
    description="API documentation for Test for Vortex App",
)
